...
public class HinduToRomanNumeralConverter {
	private static int[] denominations = new int[] {5000, 4000, 1000, 900, 500, 400, 100, 90, 50, 40, 10, 9, 5, 4, 1};
	private static String[] numerals = new String[] {"?", "M?", "M", "CM", "D", "CD", "C", "XC", "L", "XL", "X", "IX", "V", "IV", "I"};
